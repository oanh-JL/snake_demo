...
public class BoxColliderRenderer extends Renderer {
    ...
    public void render(Graphics g, GameObject master) {
        if (master instanceof Physics) {
            ...
            if (this.isFill) {
                g.fillRect(boxCollider.left(master), boxCollider.top(master), boxCollider.width, boxCollider.height);

            } else {
                g.drawRect(boxCollider.left(master), boxCollider.top(master), boxCollider.width, boxCollider.height);
            }
        }
    }
}
